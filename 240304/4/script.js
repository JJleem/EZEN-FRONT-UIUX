...
// sort함수의 기본 default값 => 작은 숫자를 좌측정렬 속성
...
const fruits = ["apple", "pear", "banana", "orange", "melon"];
console.log(fruits);
fruits.shift();
console.log(fruits);
...
// split(구분자) : 문자열 => 배열
// slice(인덱스) : 문자열 내 특정 인덱스 값 부터 문자열
...
// splice함수 : 원본 배열 데이터 에도 영향을 미친다
// slice함수 : 원본 배열 데이터 에는 영향을 미치지않는다.
...
// const highScores2 = scores.filter(()=> {
//  if (score >=85)
// })
